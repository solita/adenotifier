...
class Manifest:
    ...
    def __init__(self, base_url: str, source_system_name: str, source_entity_name: str, format: str, notify_api_key: str, notify_api_key_secret: str):
        ...
        self.__session.mount('https://', HTTPAdapter(max_retries=Retry(total=3, status_forcelist=[401, 404, 429, 500, 502, 503, 504], backoff_factor=2))) # HTTP request retry settings.
